        ...
        <div class="flex flex-col md:flex-row md:gap-4">
            <div class="md:w-1/2">
                <x-controls.input type="text" id="nombre" name="nombre"
                    placeholder="Escribe el nombre de tu test" value="{{ old('nombre') }}" required autofocus />
                <x-controls.textarea id="descripcion" name="descripcion" placeholder="Escribe una breve descripción"
