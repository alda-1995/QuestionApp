...
@section('content')
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 xl:gap-x-6">
            <x-dashboard.card-encuesta title="Test de inteligencia" status="completado" startDate="29 Diciembre 2023" endDate="01 Enero 2024" />
            <x-dashboard.card-encuesta title="Test de inteligencia" status="proceso" startDate="29 Diciembre 2023" endDate="01 Enero 2024" />
            <x-dashboard.card-encuesta title="Test de inteligencia" status="proceso" startDate="29 Diciembre 2023" endDate="01 Enero 2024" />
            <x-dashboard.card-encuesta title="Test de inteligencia" status="completado" startDate="29 Diciembre 2023" endDate="01 Enero 2024" />
            <x-dashboard.card-encuesta title="Test de inteligencia" status="completado" startDate="29 Diciembre 2023" endDate="01 Enero 2024" />
            <x-dashboard.card-encuesta title="Test de inteligencia" status="completado" startDate="29 Diciembre 2023" endDate="01 Enero 2024" />
