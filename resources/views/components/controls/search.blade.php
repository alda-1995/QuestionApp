<div class="w-full relative inline-flex items-center h-[48px] bg-black rounded-3xl">
    <div class="absolute top-1/2 -translate-y-1/2 left-6">
        <svg xmlns="http://www.w3.org/2000/svg" height="16px" width="16px" class="fill-base-100 h-6 w-6"  viewBox="0 0 24 24">
            <title>magnify</title>
            <path
