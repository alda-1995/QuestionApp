...
if (btnStepOne) {
  btnStepOne.addEventListener("click", function (e) {
    ...
    clearErrors();
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#lineProgress", {
      duration: 0.8,
      width: "35%"
    });
    var tlOne = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
    tlOne.to("#first-step", {
      opacity: 0,
      xPercent: 20,
      duration: 1
    });
    tlOne.set("#second-step", {
      zIndex: 2
    });
    tlOne.to("#second-step", {
      opacity: 1,
      duration: 1
    });
    tlOne.set("#first-step", {
      zIndex: -1
    });
  });
}
var btnStepTwo = document.getElementById("btnSecondStep");
if (btnStepTwo) {
  btnStepTwo.addEventListener("click", function (e) {
    ...
    var tlTwo = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
    tlTwo.to("#second-step", {
      opacity: 0,
      xPercent: 20,
      duration: 1
    });
    tlTwo.set("#three-step", {
      zIndex: 2
    });
    tlTwo.to("#three-step", {
      opacity: 1,
...
var validateLength = function validateLength(input, minLength) {
...
var validateConfirmPassword = function validateConfirmPassword(password, confirmPassword) {
  if (password !== confirmPassword) {
    return false;
  }
  return true;
};
var showError = function showError(value, id, element) {
  var errorGeneral = document.getElementById(id);
...
var clearErrors = function clearErrors() {
  ...
  document.querySelectorAll('span[role="alert"]').forEach(function (element) {
    element.innerText = "";
  });
};
var dropDowns = document.querySelector('[data-dropdown-toggle]');
if (dropDowns) {
...
var btnOpenQuestion = document.getElementById("openModalQuestion");
if (btnOpenQuestion) {
...
if (btnMenu.addEventListener("click", function (e) {
  ...
  if (!openMenu) {
    openMenu = true;
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#sidenav", {
      duration: 1,
      x: "0%"
    });
  } else {
